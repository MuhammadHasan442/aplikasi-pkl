...
@section('konten')
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tr>
                            ...
                            <td class="text-center">
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('data-cctv-publik.destroy', $post->id) }}" method="POST">
    ...
    @endpush
    @include('data-cctv-publik.insert')
    @include('data-cctv-publik.edit')
    @include('data-cctv-publik.cetak')
@endsection
