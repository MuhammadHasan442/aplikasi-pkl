...
<head>
    ...
    <title>Laporan Wifi Publik</title>
</head>
<body>
    <center>
        <table>
    ...
    <h5 class="text text-center">LAPORAN DATA WIFI PUBLIK</h5>
    <div id="content">
        ...
        <table width="100%">
            <tbody>
                <tr>
                    <td width="60%"></td>
                    <td width="40%" align="center" style="border: none;">Banjarmasin, <?= date('d-m-Y'); ?> <br>MENGETAHUI,<br><br><br><br><br></td>
                </tr>
                <tr>
                    <td width="60%"></td>
